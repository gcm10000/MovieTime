...
namespace MovieTimeLibraryCore
{
    ...
    public class MovieInformationQuery : IQuery
    {
    ...
    public class TVInformationQuery : IQuery
    {
        public int page { get; set; }
        public int total_results { get; set; }
        public int total_pages { get; set; }
    ...
    //{
    //    public static Dictionary<int, string> FilmGenres { get; } = new Dictionary<int, string>()
    //    {
    //        { 28, "Ação" },
    //        { 12, "Aventura" },
    //        { 16, "Animação" },
